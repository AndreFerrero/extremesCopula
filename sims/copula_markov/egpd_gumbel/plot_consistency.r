...
load("sims/copula_markov/egpd_gumbel/res/consistency_mc300_u9095_neldermead_gumbeldata_joe_hill_kn05_kappa2_sigma1_xi01.RData")
...
plot_consistency(
  ...
  target_threshold = 0.95,
  scale = "raw",
  models_to_show = c("IID_EGPD", "EGPD_GUMBEL", "EGPD_JOE"),
  title = "",
  subtitle = "",
  xlab = NULL,
  ylab = NULL,
