...
\begin{frame}{Motivation: Classical Problems in Extremes Modelling}
    \begin{itemize}
        \item Classical methods require preliminary, and often \textbf{subjective}, choices before fitting the model
...
% ==========================================
\section{Classical and Modern Approaches to Extremes Modelling}
