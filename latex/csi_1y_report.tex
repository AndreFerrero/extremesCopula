...
An application of threshold-free approaches to model temporal dependence in multivariate extremes has been recently proposed by \textcite{li2026}, using a Markov structure combined with factor and vine copulas while modelling the margins with non-stationary EGPDs.
