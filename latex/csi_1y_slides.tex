...
\begin{frame}{Starting Point: Copulas and Limit Distribution of the Maxima}
  ...
  where $M_n$ is the maximum of the sequence and $G$ is the GEV limiting distribution of the maximum for iid variables from $F$. See \parencite{herrmann2024}.
\end{frame}

\begin{frame}{Starting Goal and Related Challenges}
  ...
  \begin{itemize}
      ...
      \item Only one realization of the univariate sequence.
  \end{itemize}
  \end{alertblock}
...
\begin{flushleft}
    ...
    \textcolor{gray}{\texttimes\ The connection to the theory of dependent maxima becomes unclear}
\end{flushleft}
...
\begin{flushleft}
  \textcolor{green!60!black}{\checkmark} Existing Theory for Extremes of Markov Chains and applications \parencite{drees2015, winter2016} \\
   ...
   \textcolor{red!70!black}{\texttimes} The connection to the theory of dependent maxima becomes unclear
\end{flushleft}
...
\begin{frame}{Copula Markov Chains: Simulation}
    \begin{block}{Sampling (Inverse Rosenblatt Transform)}
        \begin{enumerate}
...
\begin{frame}{Current Direction: More flexible dependence structure}
  \textbf{Question}: Can we construct Markov Chains with EGPD margin but flexible copula/dependence structure for the transitions?
