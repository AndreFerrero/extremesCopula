...
```{r, echo=FALSE}
load("C:/Users/Andrea Ferrero/extremesCopula/sims/estim/copula_markov/egpd_gumbel/res/seed46_ppcfit_2kmcmc_4chains_xsim1k.Rdata")
```


Below we have the Stan mcmc results, diagnostics and Posterior Predictive Checks on key quantities (Densities, maxima, extremogram, return levels)
```{r, echo=FALSE}
...
ggplot() +
  ...
  scale_fill_manual(values = c("Prior" = "grey70", "Posterior" = "lightblue")) +
  theme_minimal() +
