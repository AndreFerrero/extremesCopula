...
Below we can see a comparison of the estimated parameter (true value is $\theta = 1.5$) for a gumbel copula with increasing observations (K) with d = 12. The DMLE estimator has been computed 100 times for each sample size.
